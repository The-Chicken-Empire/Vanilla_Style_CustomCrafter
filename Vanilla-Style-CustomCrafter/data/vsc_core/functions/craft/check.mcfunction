...
# クラフト結果を表示していないなら、クラフト欄と一致するアイテムがあるか調べ表示する
  execute if entity @s[tag=!VSC.picked_up1,tag=!VSC.picked_up2] unless score @s VSC.craft_recipeID matches -2147483648..2147483647 run function vsc_core:craft/search_recipe
